...
public class API_KEYS {
    ...
    public  static final String API_KEY="caabe858036a9f2b5d3a39e225df3b50";
    ...
    public static String IATA="iata";
    public static String ICAO ="icao";
    ...
    public static String ESTIMATED_RUNWAY="estimated_runway";
    public static String ACTUAL_RUNWAY="actual_runway";
    public static String ARRIVAL ="arrival";
    public static String AIRLINE= "airline";
    public static String NAME = "name";
    public static String FLIGHT="flight";
    public static String NUMBER= "number";
    public static String CODE_SHARED="codeshared";
